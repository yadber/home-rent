...
export default function ForgotPassword() {
  ...
  async function onSubmit(e){
    ...
    try {
      ...
      toast.success("Reset Email was sent to your email address")
        ...
        <div  className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
            ...
            <Link to="/sign-in" className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1'>
              Sign In</Link></p>
            <p><Link to="/sign-up" className='text-blue-600 hover:text-blue-700 transition duration-200 ease-in-out'>
